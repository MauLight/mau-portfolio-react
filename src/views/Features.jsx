...
export const Features = () => {
  ...
  return (
    <div className="flex flex-col gap-x-5 gap-y-20 px-5 md:px-20 bg-black pb-32">
      ...
      <h1 id='features' className='text-end text-6xl sm:text-8xl md:text-[144px] 2xl:text-[192px] mt-20 mb-10 uppercase'>_Features</h1>
          ...
          <Link key={screenplay.id} to={`/screenplays/${screenplay.id}`}>
            <div style={{ backgroundColor: '#141314' }}
              ...
              <motion.div
                ...
                className="hidden md:flex flex-col w-screen md:w-[30vw] min-[200px]:max-sm:px-2 my-5"
              >

                <div className={`${screenplay.rounded} mx-auto w-full md:w-[30vw] max-h-[70vh] object-contain object-center rounded-[10px] group relative overflow-hidden`}>
                  <img src={screenplay.img} className={'hidden md:flex w-full max-h-full object-cover hover:scale-[110%] transition-scale duration-500'} />

                </div>

              </motion.div>
              <div className="flex flex-col justify-center">
                <h1 className='blog-item font-primary min-[200px]:max-sm:mt-3 text-4xl lg:text-8xl min-[1800px]:text-[144px]'>{screenplay.title}</h1>
