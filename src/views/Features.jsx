          ...
          <Link key={screenplay.id} to={`/screenplays/${screenplay.id}`}>
            <div style={{ backgroundColor: 'black' }}
              ...
              >
                ...
                <div className={'mx-auto w-full md:w-[30vw] max-h-[70vh] object-contain object-center group relative overflow-hidden rounded-l-[10px]'}>
              ...
              <div className="flex flex-col justify-center">
                <h1 className='font-primary min-[200px]:max-sm:mt-3 text-4xl lg:text-8xl min-[1800px]:text-[144px]'>{screenplay.title}</h1>
