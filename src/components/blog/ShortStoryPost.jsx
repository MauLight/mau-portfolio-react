...
export const ShortStoryPost = ({ shortId }) => {
  ...
  return (
    <>
      <div className='min-h-[700px] w-screen bg-[#10100e] py-20'>
        {
          shortFilter.map(script => (
            ...
            >
              <div className="flex flex-col">
                <h1 className='font-primary text-5xl sm:text-[108px] tracking-tighter text-white uppercase'>{script.title}</h1>
                <div className="flex justify-between">
                  ...
                  <div className="hidden xl:flex justify-end items-end gap-x-2">
                    ...
                    <p className='font-carbon text-[#aaaaaa] text-sm rounded-full px-2'>{script.tag}</p>
