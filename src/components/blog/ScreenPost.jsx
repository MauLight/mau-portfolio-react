      ...
      <div className='min-h-[700px] w-screen bg-white py-20'>
        {
          scriptFilter.map(script => (
            ...
            >
              <h1 className='blog-item font-primary text-black text-5xl sm:text-7xl'>{script.title}</h1>
              ...
              <div className={'mx-auto lg:w-[30vw] max-h-[90vh] object-contain object-center rounded-[10px] group relative overflow-hidden'}>
              ...
              <div className="flex flex-col">
                <div className="flex justify-center mt-10 items-center gap-x-2">
                  {
                    script.genres.map((genre, i) => (
                      <div key={i} className="border border-black rounded-full px-2">
                ...
                <div className="flex gap-x-5 my-10 items-center">
                  ...
                  <p className='font-carbon text-black text-2xl sm:text-4xl'>{script.logline}</p>
                </div>
