...
export const VideoCard = ({ id, image, video, title, genre, color }) => {
  ...
  return (
    <div
      className='w-[495px] h-auto border border-[#141314] rounded-[15px] p-1 m-1 transition-colors delay-75'
    ...
    >
      ...
      <motion.div
        ...
        className="flex pt-4"
      >
        <h1 className='font-carbon text-lg pl-4'>{title.toUpperCase()}</h1>
      </motion.div>
      <motion.div
        ...
        className="flex mb-2"
      >
        <h1 className='font-carbon text-[#b5dac9] text-[10px] pl-6'>{genre.toUpperCase()}</h1>
      </motion.div>
    </div>
  )
}
