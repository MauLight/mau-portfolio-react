...
export const VideoCard = ({ id, video, title, genre, color }) => {
  ...
  return (
    ...
    >
      <Tilt tiltMaxAngleX={1.5} tiltMaxAngleY={1.5} glareEnable={true} glareMaxOpacity={0.15} glareColor={'white'} glareBorderRadius='15px' >
        <video onClick={() => navigate(`/reel/${id}`)} className='w-full h-full object-cover  rounded-[15px]' src={video} autoPlay loop muted />
      </Tilt>
